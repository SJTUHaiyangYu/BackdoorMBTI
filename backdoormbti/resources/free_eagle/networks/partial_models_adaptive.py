...
class ResNetAdaptivePartialModel(ResNet):
    ...
    def __init__(
        ...
        super(ResNetAdaptivePartialModel, self).__init__(
            num_classes=num_classes, layers=layer_setting, block=block_setting
        )
        # inspect_layer_position indicates which layer to inspect on.
        self.inspect_layer_positions = [0, 1, 2, 3, 4, 5]
        self.inspect_layer_position = self.inspect_layer_positions[
...
class VGGAdaptivePartialModel(VGG16):
    ...
    def __init__(
        ...
        super(VGGAdaptivePartialModel, self).__init__(
            num_classes=num_classes, in_dims=in_dims
        )
        # inspect_layer_position indicates which layer to inspect on.
...
class GoogLeNetAdaptivePartialModel(GoogLeNet):
    ...
    def __init__(
        ...
        super(GoogLeNetAdaptivePartialModel, self).__init__(
    ...
    def forward(self, x, with_latent=False, fake_relu=False):
        ...
        try:
            x, aux1, aux2 = self._forward(
                x, with_latent=with_latent, fake_relu=fake_relu
            )
        except ValueError:
            final, pre_out = self._forward(
                x, with_latent=with_latent, fake_relu=fake_relu
            )
            return final, pre_out
