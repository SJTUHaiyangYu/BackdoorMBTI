...
def parse_args():
    ...
    parser.add_argument('--anno_dir', type=str, default='../data/hmdb51/testTrainMulti_7030_splits')
    parser.add_argument('--out_list_path', type=str, default='../data/hmdb51/testTrainMulti_7030_splits')
...
def download_hmdb51(args):
    ...
    # raw_rar_path = os.path.join(target_dir, 'hmdb51_org.rar')
    # if not os.path.exists(raw_rar_path):
    #     os.system('wget -P %s %s' % (target_dir, video_url))
    # try:
    #     with rarfile.RarFile(raw_test_train_rar_path) as rf:
    #         rf.extractall(path=target_dir)
    #     print(f"File {raw_test_train_rar_path} has been successfully extracted to {target_dir}")
    # except rarfile.NotRarFile:
    #     print(f"The file {raw_test_train_rar_path} is not a valid RAR file.")
    # except rarfile.BadRarFile:
    #     print(f"The file {raw_test_train_rar_path} is a corrupted RAR file.")
    # except rarfile.RarCannotExec:
    #     print(f"Failed to execute the unrar command. Ensure unrar is installed and accessible.")
    ...
    raw_test_train_rar_path = os.path.join(target_dir, 'test_train_splits.rar')
    if not os.path.exists(raw_test_train_rar_path):
